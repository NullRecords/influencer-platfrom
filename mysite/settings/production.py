...
ALLOWED_HOSTS = ['eileen-app-lrlvb.ondigitalocean.app', 'open.build', '127.0.0.1', '[::1]','www.open.build','ukraine.open.build','colombia.open.build']
...
AWS_STORAGE_BUCKET_NAME = 'eileen'
